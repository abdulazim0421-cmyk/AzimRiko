...
const ContactForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Формируем текст сообщения на основе данных с фото
        const servicesText = selectedServices.length > 0 ? selectedServices.join(', ') : 'Not selected';
        const budgetText = `$${budget[0]} - $${budget[1]}`;
...
Message: ${message || 'No message provided'}
        ...
        // Отправка в Prisma через твой Action
                    ...
                    <form className="max-w-[1100px] mx-auto space-y-6 md:space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-[#1E1E1E] border border-[#262626] rounded-xl p-6 relative after:absolute after:bottom-8 after:left-6 after:right-6 after:h-[1px] after:bg-[#262626]">
                                ...
                                <input
                                    type="text" required placeholder="Type here" value={name}
                            ...
                            <div className="bg-[#1E1E1E] border border-[#262626] rounded-xl p-6 relative after:absolute after:bottom-8 after:left-6 after:right-6 after:h-[1px] after:bg-[#262626]">
                                ...
                                <input
                                    type="email" required placeholder="Type here" value={email}
                        ...
                        <div className="bg-[#1E1E1E] border border-[#262626] rounded-xl p-6 md:p-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6">
                                {services.map((s) => (
                                    <div
                                        key={s.id}
                                        onClick={() => setSelectedServices(prev => prev.includes(s.label) ? prev.filter(i => i !== s.label) : [...prev, s.label])}
                        ...
                        <div className="bg-[#1E1E1E] border border-[#262626] rounded-xl p-6 md:p-8 relative after:absolute after:bottom-10 after:left-8 after:right-8 after:h-[1px] after:bg-[#262626]">
                            ...
                            <textarea
                                placeholder="Type here" rows={3} value={message}
                                onChange={(e) => setMessage(e.target.value)}
                                className="w-full bg-transparent text-gray-400 outline-none resize-none placeholder:text-[#4C4C4C]"
                            />
                        </div>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div className="p-6 pt-0 text-center">
                                <p className="text-gray-400 text-left mb-8">Your request has been sent successfully. Our team will contact you soon.</p>
                                <div className="flex justify-center my-10 text-[#C5FF32]">
                                    <Check size={80} strokeWidth={3} />
                                </div>
                                <button onClick={() => setIsModalOpen(false)} className="w-full bg-[#262626] border border-[#333] text-white py-3 rounded-lg font-bold hover:bg-[#333] transition-all text-xs tracking-widest">
                                    CLOSE
                                </button>
                            </div>
                        </motion.div>
